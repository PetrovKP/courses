...
foreach (_MKL_VER ${_MKL_TEST_VERSIONS})
    if (WIN32)
        ...
        list(APPEND _MKL_ROOT_SEARCH_DIRS "/opt/intel/mkl/")
...
foreach (_MKL_LIB_RAW ${_MKL_LIBRARIES})
    set(_MKL_LIB ${MKL_LIB_PREFIX}${_MKL_LIB_RAW}${MKL_LIB_SUFFIX})

    message(STATUS ${_MKL_LIB})
